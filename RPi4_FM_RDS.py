...
# Title: RPi4 FM RDS
# Generated: Thu May  7 12:01:00 2020
##################################################
...
class RPi4_FM_RDS(grc_wxgui.top_block_gui):

    def __init__(self):
        grc_wxgui.top_block_gui.__init__(self, title="RPi4 FM RDS")
        ...
        self.nbook.GetPage(4).Add(self.wxgui_scopesink2_1.win)
...
def main(top_block_cls=RPi4_FM_RDS, options=None):
